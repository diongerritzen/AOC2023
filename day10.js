...
function returnDay10Part1Result(input) {
	return parseInput(input);
}

const day10InputEx1 = `-L|F7
7S-7|
L|7||
-L-J|
L|-JF`;

const day10InputEx2 = `7-F7-
.FJ|7
SJLL7
|F--J
LJ.LJ`;

const day10Input = `|-F7|77FJ-J7..L.-7-7.F--7-J7-FJ7|.FFFF7F-|7|7.J.-|7--F|-LL---77FF--7-|-LF77F|7FF-JFF7FJ-|7F.F7FFL-J7FFL-J-7-FFF7JF|-L77|-F7.FL7F7-7.7.FLF-F7
