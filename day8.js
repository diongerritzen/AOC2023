function parseInput(input) {
	const [route, _,  ...nodes] = input.split('\n');
	const nodesObject = {};
	nodes.forEach(node => 
		nodesObject[node.substring(0, 3)] = [
			node.substring(0, 3),
			node.substring(7, 10),
			node.substring(12, 15)
		]);
	return [
		route
			.replaceAll('L', 1)
...
function returnDay8Part1Result(input) {
	return navigateNetwork(...parseInput(input));
}

function returnDay8Part2Result(input) {
	return navigateNetworkAsGhost(...parseInput(input));
}

const day8InputEx1 = `RL
...
const day8InputEx2 = `LLR

AAA = (BBB, BBB)
BBB = (AAA, ZZZ)
ZZZ = (ZZZ, ZZZ)`;

const day8InputEx3 = `LR
...
const day8Input = `
